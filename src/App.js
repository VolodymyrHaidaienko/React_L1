...
function App() {
  ...
  return (
    <div className="App">
        {/*{*/}
        {/*    simpsons.map(value => <Simpson name={value.name} surname={value.surname} age={value.age} info={value.info} photo={value.photo}/>)*/}
        {/*}*/}
        {/*{*/}

        {/*    usersList.map(value => <*/}
        {/*        UsersList id={value.id}*/}
        {/*                  name={value.name}*/}
        {/*                  username={value.username}*/}
        {/*                  email={value.email}*/}
        {/*                  addressstreet={value.address.street}*/}
        {/*                  addresscity={value.address.city}*/}
        {/*                  addresssuite={value.address.suite}*/}
        {/*                  addresszipcode={value.address.zipcode}*/}
        {/*                  geolat={value.address.geo.lat}*/}
        {/*                  geolng={value.address.geo.lng}/>)*/}
        {/*}*/}

        {
            userlist.map(value => <SpaceX
